...
function addTownSummary(){
  ...
  fetch("https://api.openweathermap.org/data/2.5/weather?id=5604473&appid=a0770b37c9ae8c9a3f8405f6c9b38c60")
  .then(response => {
    return response.json()
  })
  .then(
...
function update5Day(){
  function write5day(dayData){
    ...
    for (let i = 0; i < days.length; i ++){
      let day = days[i];
      day.firstElementChild.innerText = numToDay(days[i].getAttribute('data-day'));
  ...
  fetch("https://api.openweathermap.org/data/2.5/forecast?id=5604473&appid=a0770b37c9ae8c9a3f8405f6c9b38c60")
  .then(response => {
    return response.json()
  })
  .then(
